...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				.apiInfo(new ApiInfo("Security APIs", "Permission service API's Specifications", "2.0.0", "© 2016 Fluance", "Fluance Middleware", "© 2016 Fluance", "http://fluance.net/"))
	...
	private Predicate<String> paths() {
		return or(regex("/xamcl.*"), regex("/xacml.*"));
	}
}